...
contract WCardsDrawV2 is VRFConsumerBaseV2, Ownable, Initializable {
    ...
    event DrawClose(uint256 drawId, uint256[] winningNums);
    ...
    function claimBatchReward(uint256[] memory _drawIds, uint256[] memory _tokenIds) external notContract {
        ...
        for (uint256 i = 0; i < len; i++) {
            ...
            allDraws_[_drawId].prizePoolInWBlock -= prizeAmount;
    ...
    function _prizeForMatching(uint8 _noOfMatching, uint256 _drawId) internal view returns (uint256) {
        ...
        prize = (allDraws_[_drawId].prizePoolInWBlock * perOfPool);
        return prize / 100000;
    }
    ...
    function fulfillRandomWords(uint256 _requestId, uint256[] memory _randomWords) internal override {
        ...
        emit DrawClose(_drawId, draw.winningNumbers);
    }
}
